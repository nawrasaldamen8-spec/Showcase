...
public class AddSocialLink : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost("api/profiles/me/social-links", async (
            AddSocialLinkCommand command,
            ISender sender,
        ...
        .WithName(nameof(AddSocialLink))
        .Produces<SocialLinkDto>(StatusCodes.Status200OK)
